...
连接的后端数据库：MySQL 8.0.13 [ 需要后端修改 ]

项目运行环境：Python 3.9 [ 需要后端修改 ]

浏览器：Google Chrome

后端开发：Django 4.0.4 [ 需要后端修改 ]
...
![image-20230603163704761](C:\Users\86185\AppData\Roaming\Typora\typora-user-images\image-20230603163704761.png)
...
![image-20230603163743915](C:\Users\86185\AppData\Roaming\Typora\typora-user-images\image-20230603163743915.png)
...
#### 4.1.2前端vue项目打包自动上传(本地部署)

本项目采用python构建自动部署可执行程序，其步骤如下：

1.将vue项目打包并将dist文件压缩,打包过程代码如图所示：

![image-20230603174546642](C:\Users\86185\AppData\Roaming\Typora\typora-user-images\image-20230603174546642.png)

2.将压缩包传输到服务器指定目录下。其过程代码如图所示：

![image-20230603174601908](C:\Users\86185\AppData\Roaming\Typora\typora-user-images\image-20230603174601908.png)

3.建立ssh链接执行替换操作。替换文件并重启nginx如图所示：

![image-20230603174830095](C:\Users\86185\AppData\Roaming\Typora\typora-user-images\image-20230603174830095.png)

4.删除本地文件。删除本地文件代码如图所示：

![image-20230603174836745](C:\Users\86185\AppData\Roaming\Typora\typora-user-images\image-20230603174836745.png)
