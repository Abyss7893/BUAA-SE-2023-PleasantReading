...
![deploy_front (1)](deploy_img/deploy_front (1).png)
...
![deploy_front (2)](./deploy_img/deploy_front (2).png)
...
![deploy_front (3)](./deploy_img/deploy_front (3).png)

![deploy_front (4)](./deploy_img/deploy_front (4).png)

2.将压缩包传输到服务器指定目录下。其过程代码如图所示：

![deploy_front (5)](.\deploy_img\deploy_front (5).jpg)

3.建立ssh链接执行替换操作。替换文件并重启nginx如图所示：

![deploy_front (6)](./deploy_img/deploy_front (6).png)

4.删除本地文件。删除本地文件代码如图所示：

![deploy_front (7)](./deploy_img/deploy_front (7).png)
