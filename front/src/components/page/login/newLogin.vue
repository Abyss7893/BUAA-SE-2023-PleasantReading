...
export default {
  ...
  setup(_, { emit }) {
    ...
    const showStatus = () => {
      return aContainer.value.classList.contains("is-txl");
    }
    const mainF = () => {
